...
export const getHardcodedCitreaIcons = (address: string) => {
  ...
  if (address === '0x8D82c4E3c936C7B5724A382a9c5a4E6Eb7aB6d5D'.toLowerCase())
    return 'https://assets.coingecko.com/coins/images/71615/standard/ctusd-logo.jpg?1768554212'
  if (address === '0xE045e6c36cF77FAA2CfB54466D71A3aEF7bbE839'.toLowerCase())
    return 'https://assets.coingecko.com/coins/images/6319/standard/USDC.png?1769615602'
  if (address === '0xDF240DC08B0FdaD1d93b74d5048871232f6BEA3d'.toLowerCase())
    return 'https://assets.coingecko.com/coins/images/39529/standard/WBTCLOGO.png?1764684093'
