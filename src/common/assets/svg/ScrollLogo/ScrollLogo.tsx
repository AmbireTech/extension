...
const ScrollLogo: React.FC<Props> = ({ width = 32, height = 32, ...rest }) => (
  <Svg width={width} height={height} viewBox="0 0 32 32" {...rest}>
    <G transform="translate(-283 -64)">
      <G transform="translate(289.712 70.857)">
        <Path
          d="M17.227,12.408V1.621A1.648,1.648,0,0,0,15.583,0H4.369A4.451,4.451,0,0,0,0,4.459,4.378,4.378,0,0,0,.563,6.6,5.227,5.227,0,0,0,1.734,7.949a2.045,2.045,0,0,0,.45.293,4.791,4.791,0,0,0,1.126.473v6.441a3.586,3.586,0,0,0,.135.878A2.874,2.874,0,0,0,5.179,17.97a4.015,4.015,0,0,0,1.194.248l8.94.045a3.239,3.239,0,0,0,1.914-5.855Z"
          fill="#ffeeda"
        />
        <Path
          d="M48.91,59.407a2.155,2.155,0,0,1-2.139,2.072l-6.17-.023a3.19,3.19,0,0,0,.788-2.117,3.594,3.594,0,0,0-.743-2.139h6.148a2.153,2.153,0,0,1,2.139,2.139Z"
          transform="translate(-31.457 -44.319)"
          fill="#ebc28e"
        />
        <Path
