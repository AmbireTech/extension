...
const SafeBadgeIcon: React.FC<SafeBadgeIconProps> = ({
  width = 24,
  height = 24,
  color,
  symbolColor,
  ...
  const circleColor = color || SAFE_BRAND_GREEN
  ...
  return (
    <Svg width={width} height={height} viewBox={PADDED_VIEW_BOX} fill="none" {...rest}>
      ...
      />
      <Path
        d="M34.5833 38.3777C34.5833 36.4979 36.0611 34.9747 37.8847 34.9747H62.161C63.9847 34.9747 65.4622 33.4515 65.4622 31.5719V25.2779C65.4622 23.3982 63.9847 21.875 62.161 21.875H36.4773C34.6539 21.875 33.1761 23.3982 33.1761 25.2779V30.1277C33.1761 32.0073 31.6986 33.5305 29.8749 33.5305H25.1763C23.3527 33.5305 21.875 35.0537 21.875 36.9335V47.5536C21.875 49.4334 23.3588 50.8801 25.1824 50.8801H31.2882C33.1119 50.8801 34.5896 49.357 34.5896 47.4772L34.5833 38.3777Z"
        fill={markColor}
      />
      <Path
        d="M47.1561 44.2715H53.0211C54.9325 44.2715 56.4831 45.871 56.4831 47.84V53.8856C56.4831 55.8556 54.9313 57.4539 53.0211 57.4539H47.1561C45.2449 57.4539 43.6943 55.8543 43.6943 53.8856V47.84C43.6943 45.8698 45.2461 44.2715 47.1561 44.2715Z"
        fill={markColor}
      />
    </Svg>
  )
...
export default React.memo(SafeBadgeIcon)
