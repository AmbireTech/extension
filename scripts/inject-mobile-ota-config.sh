...
#
# The native files (iOS Info.plist, Android strings.xml) are committed with the
# placeholders __STALLION_PROJECT_ID__ / __STALLION_APP_TOKEN__ so the real values
# never live in git. This script replaces those placeholders with the real values
...
#
# Requires STALLION_PROJECT_ID and STALLION_APP_TOKEN (from .env or environment).
